<template>
    <!-- <div class="magnify">
        <div class="left_contaner">
            ...
            <div class="carousel">
                <div class="left" @click="leftArrowClick">
                    <img src="http://www.jq22.com/demo/jQuery-fdj201705051102/images/btn_prev.png" alt="">
                </div>
                <div class="show_box">
                ...
                <div class="right" @click="rightArrowClick">
                    <img src="http://www.jq22.com/demo/jQuery-fdj201705051102/images/btn_next.png" alt="">
                </div>
            </div>
        </div>
